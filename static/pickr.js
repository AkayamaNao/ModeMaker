    ...
    return function (t) {
        ...
        var h = function () {
            function t(e) {
                ...
                this.root = this._buildRoot(), this.inputActive = !1, this.color = new a.HSVaColor, this.lastColor = new a.HSVaColor, this._rePositioningPicker(!0), this._buildComponents(), this._bindEvents(), this.setColor(this.options.default), this.hide()
            }
            ...
            return r(t, [{
                ...
                value: function () {
                    ...
                    var t, e, o, r, i = this.options.el,
                        ...
                        }, Array.from(r.input.options).find(function (t) {
                        ...
                        o = {
                            palette: new c.default({
                                ...
                                onchange: function (e, o) {
                                    ...
                                    // console.log(n);
                                    $('#selected_color').val(n);
                                    t.root.button.style.background = n;
